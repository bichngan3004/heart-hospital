...
<body>
    ...
    <div id="khoas" class="khoas">
        ...
        <?php $p->showkhoa("SELECT * FROM khoa order by id_khoa asc limit 8") ?>
    ...
    <div id="doctors" class="doctors">
        ...
        <?php $p->showbacsi("SELECT * FROM bacsi ORDER BY id_bacsi asc limit 8")
    ...
    <div class="rule">
        ...
        <div class="container" id="contact">
            ...
            <div class="row mt--20">
                ...
                <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12" style="float:left">
                    <div class="news" >
                        <?php
                         include("class/listds.php");
                         $k = new listds();
                        $k->loadlistnewsdetailsec("SELECT * FROM tintuc order by id_tintuc desc limit 3") 
                        ?>
                        ...
                        // include("class/listds.php");
                        // $k = new listds();
                        // $k->loadlistnew("SELECT * FROM tintuc order by id_tintuc asc limit 3");
                        ?>
                    </div>
