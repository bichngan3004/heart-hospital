...
if(isset($_POST['next'])):
    ...
    $_SESSION['benhnhan'] = $_POST['benhnhan'];	
...
for ( $day = 1; $day <= $day_count; $day++, $str++) {
    ...
    if($str % 7 == 0 || strtotime($date) < strtotime($today)):
        ...
        $caLamViec = "<br>
            ...
            <label><input type='radio' name='ngayhen' value='3_$date'>13:00 - 15:00</label>
...
<head>
    ...
    <div class="container mt-1 mb-3">
        ...
        <table class="table table-bordered" id = "calendar">
            ...
            <form action="savelichbn.php" method="POST">
            <?php
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-2 text-left">
                    ...
                    <input type="hidden" name="benhnhan" value="<?php echo $_POST['benhnhan'];?>">
